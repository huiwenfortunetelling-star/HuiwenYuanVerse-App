...
(() => {
  ...
  const BASE_TRANSLATIONS = new Map(Object.entries({
    ...
    '咨询会议时长为 30 分钟': 'Consultation meetings are 30 minutes long.',
    ...
    '佣金余额需满 ￥0.05 才能申请提现。': 'Your commission balance must reach ¥0.05 before you can request a withdrawal.',
    ...
    '本次咨询已达到 30 分钟，咨询已结束。': 'This 30-minute consultation has ended.',
    '咨询进行中 · 会议时长 30 分钟': 'Consultation in progress · 30-minute session',
